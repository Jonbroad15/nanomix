...
class TestMain(unittest.TestCase):
    ...
    def test_assign_fragments(self):
        # assign fragments
        assignments = assign_fragments(methylome, atlas, sigma_path)

        # assert if true_assignments and assignments are the same
        self.assertEqual(assignments, true_assignments)
